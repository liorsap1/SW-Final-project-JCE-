...
## [Issue Board](https://github.com/liorsap1/SW-Final-project-JCE-/issues)
...
In this project I am developing Android Application for connectiong routers. Among the app functions, the application is capable
to get all information about the router connected to source device and config the router settings.
